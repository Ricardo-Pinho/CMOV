...
public class User implements Serializable {
	...
	public ArrayList<Integer> busIds;
	...
	public User(String Name, String Nickname, String Password, String Id)
	{
		this.Name=Name;
	...
	public User(String Name, String Nickname, String Password, String Id, byte[] encryptedPassword, byte[] salt, ArrayList<Tickets> tickets)
	{
		this.Name=Name;
		this.Nickname=Nickname;
		this.Password=Password;
	...
	public void Save()
	{
		try{
			...
			File Directory = new File(Environment.getExternalStorageDirectory()+"/Passenger_data/");
			// have the object build the directory structure, if needed.
			if (!Directory.exists()) {
			    Directory.mkdirs();
			}
			File file = new File(Environment.getExternalStorageDirectory()+"/Passenger_data/", this.Nickname+".data");
			if (!file.exists()) {
			    file.createNewFile();
			}
